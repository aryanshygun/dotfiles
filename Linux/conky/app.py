...
# opacity = 205
opacity = 255
with open("/home/ryan/dotfiles/Linux/conky/colors.json", "r") as f:
    color = json.load(f)
...
${execi 10 /home/ryan/dotfiles/Linux/conky/scripts/weather.sh "$(cat /home/ryan/dotfiles/Linux/conky/scripts/.weather_api)"}${execi 10 /home/ryan/dotfiles/Linux/conky/scripts/weather-icon.sh $(jq -r '.weather[0].icon' /home/ryan/dotfiles/Linux/conky/scripts/weather.json)}\
${image /home/ryan/dotfiles/Linux/conky/scripts/weather-icon.png -p 240,-1 -s 175x175}\
${font Oswald:size=12:bold}${execi 100 jq -r '.name' /home/ryan/dotfiles/Linux/conky/scripts/weather.json} - ${execi 100 jq '.main.temp | floor' /home/ryan/dotfiles/Linux/conky/scripts/weather.json}°C
${execi 100 jq -r '.weather[0].description' /home/ryan/dotfiles/Linux/conky/scripts/weather.json | sed 's/.*/\u&/'}${font}
Wind: ${execi 100 jq '.wind.speed' /home/ryan/dotfiles/Linux/conky/scripts/weather.json} km/h
Humidity: ${execi 100 jq '.main.humidity' /home/ryan/dotfiles/Linux/conky/scripts/weather.json}%
Feels Like: ${execi 100 jq '.main.feels_like | floor' /home/ryan/dotfiles/Linux/conky/scripts/weather.json}°C
]];
...
def set_widget(widget):
    ...
    with open(f"/home/ryan/dotfiles/Linux/conky/widgets/{widget['name']}.conf", "w") as f:
        f.write(file)
