...
# root is royalblue
alias mysql-start='sudo launchctl load -w /Library/LaunchDaemons/com.oracle.oss.mysql.mysqld.plist'
alias mysql-stop='sudo launchctl unload -w /Library/LaunchDaemons/com.oracle.oss.mysql.mysqld.plist'
...
export PATH=$PATH:/Users/ryan/.spicetify

# Lazy-load Conda
conda() {
    # Load Conda function on demand
    unset -f conda
